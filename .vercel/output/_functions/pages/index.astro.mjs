...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="utf-8"><title>', '</title><meta name="description"', '><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon-bird.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&display=swap" rel="stylesheet"><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="/og.jpg"><!-- Twitter --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:image" content="/og.jpg">', '</head> <body class="bg-bg text-text font-sans"> ', ' <!-- Bandsintown widget (already used in Shows section) --> <script charset="utf-8" src="https://widget.bandsintown.com/main.min.js"><\/script> <!-- Low-motion reveal --> <script src="/reveal.js" defer><\/script> </body> </html>'])), title, addAttribute(description, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(title, "content"), addAttribute(description, "content"), renderHead(), renderSlot($$result, $$slots["default"]));
...
const $$BandcampCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="w-full card"> <div class="relative aspect-square w-full overflow-hidden"> <iframe${addAttribute(src, "src")}${addAttribute(title, "title")} class="absolute inset-0 h-full w-full border-0" loading="lazy" allow="autoplay; encrypted-media" seamless></iframe> </div> </div>`;
...
const $$VideoGrid = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="w-full"> <!-- Premier Video Section --> <div class="px-6 mb-8"> <div class="relative group cursor-pointer card"${addAttribute(premierVideo.id, "data-video-id")}> <!-- Premier Thumbnail Container --> <div class="relative aspect-[21/9] rounded-lg overflow-hidden shadow-2xl bg-gray-900"> <!-- YouTube Thumbnail --> <img${addAttribute(`https://img.youtube.com/vi/${premierVideo.id}/maxresdefault.jpg`, "src")}${addAttribute(premierVideo.title, "alt")} class="w-full h-full object-cover" loading="lazy"> <!-- Custom Play Overlay --> <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 group-hover:bg-opacity-50 transition-all duration-300"> <div class="bg-white bg-opacity-20 rounded-full p-6 group-hover:bg-opacity-30 transition-all duration-300"> <svg class="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24"> <path d="M8 5v14l11-7z"></path> </svg> </div> </div> <!-- Video title on hover --> <div class="absolute bottom-0 left-0 right-0 bg-black/80 text-white p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300"> <p class="text-lg font-medium">${premierVideo.title}</p> </div> </div> </div> </div> <!-- Grid Videos Section --> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6"> ${gridVideos.map((video) => renderTemplate`<div class="relative group cursor-pointer card"${addAttribute(video.id, "data-video-id")}> <!-- Thumbnail Container --> <div class="relative aspect-video rounded-lg overflow-hidden shadow-lg bg-gray-900"> <!-- YouTube Thumbnail --> <img${addAttribute(`https://img.youtube.com/vi/${video.id}/hqdefault.jpg`, "src")}${addAttribute(video.title, "alt")} class="w-full h-full object-cover" loading="lazy"> <!-- Custom Play Overlay --> <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 group-hover:bg-opacity-50 transition-all duration-300"> <div class="bg-white bg-opacity-20 rounded-full p-4 group-hover:bg-opacity-30 transition-all duration-300"> <svg class="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 24 24"> <path d="M8 5v14l11-7z"></path> </svg> </div> </div> <!-- Video title on hover --> <div class="absolute bottom-0 left-0 right-0 bg-black/80 text-white p-3 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300"> <p class="text-sm font-medium">${video.title}</p> </div> </div> </div>`)} </div> </div> ${renderScript($$result, "/Users/luca/WORKING FOLDER/WEBSITES/Little Sparrow/src/components/VideoGrid.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/luca/WORKING FOLDER/WEBSITES/Little Sparrow/src/components/VideoGrid.astro", void 0);

const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="about" class="relative py-20 bg-cover bg-center bg-no-repeat reveal" style="background-image: url('/images/about-bg.jpg')"> <!-- Dark Overlay --> <div class="absolute inset-0 bg-black/50"></div> <!-- Content --> <div class="relative z-10 container mx-auto px-4 max-w-4xl"> <div class="text-center mb-12"> <h2 class="text-4xl md:text-5xl font-bold text-center text-white mb-8"> <span>About</span> </h2> </div> <div class="text-white text-lg leading-relaxed space-y-6 text-center"> <p>
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const videos = [
    { id: "IvFim5nfzvU", title: "Moondust" },
    { id: "grNgRgBwXlc", title: "Tears" },
    { id: "7RGB9T4TYN0", title: "The Final Countdown" },
    { id: "x_DsAjAxN_E", title: "Baggy Trousers" },
    { id: "0HA0ZRclY2g", title: "Memories Made" },
    { id: "sopbXZJxrHY", title: "Alone" },
    { id: "8tg0E9Xnyro", title: "Corner of the Room" }
  ];
  const tracks = [
    {
